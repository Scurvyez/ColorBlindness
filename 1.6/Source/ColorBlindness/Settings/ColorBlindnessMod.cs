...
namespace ColorBlindness
{
    public class ColorBlindnessMod : Mod
    {
        ...
        private readonly CBModSettings _settings;
        
        public ColorBlindnessMod(ModContentPack content) : base(content)
        {
            mod = this;
            _settings = GetSettings<CBModSettings>();
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            list.CheckboxLabeled("CB_EnableColorBlindMode".Translate(), ref _settings._EnableColorBlindModes, "CB_EnableColorBlindModeDesc".Translate());

            DrawSettingWithTexture(list, "CB_SettingProtanopia".Translate(), ref _settings._ProtanopiaMode, TexButtons.ProtanopiaMode);
            DrawSettingWithTexture(list, "CB_SettingProtanomaly".Translate(), ref _settings._ProtanomalyMode, TexButtons.ProtanomalyMode);
            DrawSettingWithTexture(list, "CB_SettingDeuteranopia".Translate(), ref _settings._DeuteranopiaMode, TexButtons.DeuteranopiaMode);
            DrawSettingWithTexture(list, "CB_SettingDeuteranomaly".Translate(), ref _settings._DeuteranomalyMode, TexButtons.DeuteranomalyMode);
            DrawSettingWithTexture(list, "CB_SettingTritanopia".Translate(), ref _settings._TritanopiaMode, TexButtons.TritanopiaMode);
            DrawSettingWithTexture(list, "CB_SettingTritanomaly".Translate(), ref _settings._TritanomalyMode, TexButtons.TritanomalyMode);
            DrawSettingWithTexture(list, "CB_SettingAchromatopsia".Translate(), ref _settings._AchromatopsiaMode, TexButtons.AchromatopsiaMode);
            DrawSettingWithTexture(list, "CB_SettingAchromatomaly".Translate(), ref _settings._AchromatomalyMode, TexButtons.AchromatomalyMode);
